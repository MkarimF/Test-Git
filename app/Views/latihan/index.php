...
<body>
    ...
    <!-- header -->
    <header id="header" class="header header-secondary section">
        ...
        <div class="container">
            ...
            <div class="header-main">
                <h1 class="header-title wow fadeInLeft"><i class="fas fa-bezier-curve" style="font-size: 40px; margin-right: 8px;"></i> Latihan Soal</h1>
            </div>
            <!-- header main -->
    ...
    <section class="prodies">
        <div class="container grid">
            <a href="/soal/index/latihan6">
                <div class="prodi-item text-center wow bounceInLeft">
                    <h2>Latihan Soal Perkalian dan Pangkat Dua (MUDAH)</h2>
                    <img src="images/image 3.png" width="50%;" height="50%;">
                </div>
            </a>

            <a href="/soal/index/latihan7">
                <div class="prodi-item text-center wow bounceInLeft">
                    <h2>Latihan Soal Perkalian dan Pangkat Dua (SEDANG)</h2>
                    <img src="images/image 4.png" width="50%;" height="50%;">
                </div>
            </a>

            <a href="/soal/index/latihan8">
                <div class="prodi-item text-center wow bounceInLeft">
                    <h2>Latihan Soal Perkalian dan Pangkat Dua (SULIT)</h2>
